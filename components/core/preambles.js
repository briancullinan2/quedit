...
const EXTENSION_TO_MODE = {
    ...
    'bat': 'batchfile', 'bash': 'sh', 'c': 'antlr_worker', 'cbl': 'cobol', 'cc': 'antlr_worker',
    ...
    'cpp': 'antlr_worker', 'cs': 'csharp', 'css': 'css', 'csx': 'csharp', 'cxx': 'antlr_worker',
    ...
    'groovy': 'groovy', 'gsh': 'groovy', 'gvy': 'groovy', 'gy': 'groovy', 'h': 'antlr_worker',
    'haml': 'haml', 'handlebars': 'handlebars', 'hbs': 'handlebars', 'hh': 'antlr_worker',
    'hjson': 'hjson', 'hpp': 'antlr_worker', 'hrl': 'erlang', 'hs': 'haskell', 'htm': 'html',
    'html': 'html', 'htaccess': 'apache_conf', 'hxx': 'antlr_worker', 'i': 'antlr_worker', 'ini': 'ini',
    'ino': 'antlr_worker', 'io': 'io', 'java': 'java', 'jade': 'pug', 'jl': 'julia', 'js': 'javascript',
    'json': 'antlr_worker', 'jsm': 'javascript', 'jsp': 'jsp', 'jsx': 'jsx', 'kt': 'kotlin',
