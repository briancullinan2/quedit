...
10. DONE: **Layout Shifter and Share Links:** Wire up the shareable multiplayer game links, fullscreen toggle, and screen layout button. The layout button should instantly switch the app between side-by-side mode, a bottom-split terminal mode, and a stacked scrolling list designed for mobile phones using [CSS Flexible Box Layout (Flexbox)](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Flexible_Box_Layout).
